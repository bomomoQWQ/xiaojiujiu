"""1) 2259606745 补档案后的变化（restraint 应朝新目标衰减，沉默效用应跌破候选）
...
print("=== 1) 2259606745 ===")
con = sqlite3.connect("file:/data/default-friendmessage-2259606745/companion.sqlite3?mode=ro",
                      uri=True)
...
for tag, lo, hi, label in (
    ("728260403", "2026-09-17T14:46:38", "2026-09-17T14:47:30", "两条间隔 2s（窗口内，应合并）"),
    ("1913447173", "2026-09-17T14:45:40", "2026-09-17T14:46:30", "两条间隔 20s（窗口外，应各自回）"),
):
