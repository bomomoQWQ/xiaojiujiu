...
cat "$RUN/people/default-friendmessage-1670681411/summary.json"
echo
echo "=== 2) 回放（真人，尾部） ==="
python3 "$SRC/replay_session.py" --export "$RUN/people/default-friendmessage-1670681411" 2>&1 | tail -16
echo
