...
docker exec xxj-runtime-fleet /bin/sh -c "tail -6 /data/logs/default-friendmessage-qq01.log"
...
docker exec xxj-runtime-fleet /bin/sh -c "grep -c 'outbox/lease' /data/logs/default-friendmessage-qq01.log || true"
