...
预期：qq01 活跃 11 -> 7；qq02 活跃 7 -> 3；其余 5 个实例不动。
...
PLAN = [
    ("qq01", "127bca", "6d0a6f", "奶茶邀约同一件事的最早版本（3 次提及）"),
    ("qq01", "1113e0", "6d0a6f", "同上：无糖奶茶是同一邀约的另一种说法"),
    ("qq01", "627e5b", "5a93ed", "「我试试什么（）」同一问题的重复建档"),
    ("qq01", "03e558", "4d5e74", "夜羊社作品同一问题（哪部/为何喜欢）"),
    ("qq02", "d2f2ac", "9cb17d", "句号偏好同一问题的最早版本（3 次提及）"),
    ("qq02", "ee4a2f", "9cb17d", "同上：回应形式（换行/句号）偏好"),
    ("qq02", "42ceb9", "46d686", "「只收到自动回复」同一诉求的第三次提及"),
    ("qq02", "3e55d2", "46d686", "同上：第一次提及"),
]
