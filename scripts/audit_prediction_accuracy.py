...
PORTS = {
    "default-friendmessage-qq01": 8787,
    "default-friendmessage-qq02": 8788,
    "default-friendmessage-qq03": 8789,
    "default-friendmessage-qq04": 8790,
    "default-friendmessage-qq08": 8791,
    "default-friendmessage-qq06": 8792,
...
for path in sorted(glob.glob("/data/*/companion.sqlite3")):
    ...
    # 混在一起算出来的斜率毫无意义（qq03 就是这么被算出 +0.0056/h 的）。
    if len(dec) >= 2:
        sent = con_sent = None
        live_window = None
